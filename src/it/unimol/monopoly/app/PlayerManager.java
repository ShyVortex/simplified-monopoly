...
public class PlayerManager implements Serializable {
    ...
    public void savePlayers() throws IOException {
        try (
                FileOutputStream fileOutStr = new FileOutputStream("src/it/unimol/monopoly/saves/players.sr");
    ...
    public static PlayerManager loadPlayers() throws FileNotFoundException {
        try (
                FileInputStream fileInStr = new FileInputStream("src/it/unimol/monopoly/saves/players.sr");
